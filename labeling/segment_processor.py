...
2. 如果場景、地點、人物名字在影片裡沒有明說，就不要自己取名，也不要說特定地點名稱（例如倫敦塔橋、學校屋頂、荒野廢墟），只能用外觀描述，如「像歐洲街道的地方」「室內辦公室」「夜晚的城市」。
3. 每一句都要寫成「我要找那段……的畫面」這種可搜尋的說法，要具體、有畫面、有可見動作或台詞。
4. 可以用觀察到的外型來指人，例如「戴墨鏡的金髮男生」「穿黑外套的女生」「拿撲克牌的人」，不要寫出影片中沒有的稱呼。
5. 不要出現這一小段影片裡沒有的事件，例如「五個人影圍著發光符號」如果沒看到就不能寫。
6. 若你不確定物品的功能，可以用「像是…的東西」「好像在發光的牌」這種不確定語氣，但仍然必須是影片中真的看到的東西。
